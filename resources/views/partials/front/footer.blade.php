        ...
        <div class="row footer-top">
            <div class="col-lg-4 footer-grid_section_w3layouts">
                <h2 class="logo-2 mb-lg-4 mb-3">
                    <a href="{{route('shoesHome')}}"><span class="fa fa-bold" aria-hidden="true"></span>ootie</a>
                </h2>
                ...
                <div class="row mt-lg-4 bottom-w3layouts-sec-nav mx-0">
                    <div class="col-md-4 footer-grid_section_w3layouts">
                        ...
                        <ul class="list-unstyled w3layouts-icons">
                            <li>
                                <a href="{{route('shoesHome')}}">Home</a>
                            </li>
                            <li class="mt-3">
                                <a href="{{route('shoesAbout')}}">About Us</a>
                            </li>
                            <li class="mt-3">
                                <a href="#">Gallery</a>
                            </li>
                            ...
                            <li class="mt-3">
                                <a href="{{route('shoesContact')}}">Contact Us</a>
                            </li>
                        </ul>
                    </div>
                    <div class="col-md-4 footer-grid_section_w3layouts">
